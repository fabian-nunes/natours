...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZmFiaWFubnVuZXMiLCJhIjoiY2swdngweXNoMDhmbzNjcGZmdHk5cGI3NSJ9.Mu8vVgt6W94NFdMm2ek4SQ';
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(email, password, passwordConfirm, name) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var stripe = Stripe('pk_test_RkjJvYnCtIGkMU0tUhgJD3aF00eySdtVY3');
...
if (singupForm) {
  singupForm.addEventListener('submit', function (e) {
    ...
    (0, _signup.signup)(email, password, passwordConfirm, userName);
  });
}
